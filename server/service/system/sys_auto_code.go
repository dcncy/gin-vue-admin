...
import (
	...
	ast2 "github.com/dcncy/gin-vue-admin/server/utils/ast"

	"github.com/dcncy/gin-vue-admin/server/resource/autocode_template/subcontract"
...
func Init(Package string) {
	...
	packageInjectionMap = map[string]astInjectionMeta{
		packageServiceName: {
			...
			importCodeF:  "github.com/dcncy/gin-vue-admin/server/%s/%s",
			packageNameF: "%s",
